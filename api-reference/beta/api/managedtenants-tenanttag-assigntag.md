...
description: "Assigns a tenant tag to a managed tenant."
...
Assigns a tenant tag to a managed tenant.
...
|:---|:---|:---|
|tenantIds|String collection|A collection of Azure Active Directory tenant identifier for the managed tenant where this tenant tag is assigned.|
